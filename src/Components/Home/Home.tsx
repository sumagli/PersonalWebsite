...
export default function Home() {
    return (
        <div className={styles.home}>
            ...
            <p className={styles.homeText}>I have robust experience with with the folowing programming laguages C#, React, Java, and other related technologies, including, CSS, and JavaScript.</p>
